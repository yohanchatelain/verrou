...
#define DEFINE_INTERP_LIBM1_C_IMPL(FCT)                                        \
  ...
  double FCT(double a) {                                                       \
    if (ROUNDINGMODE == VR_NATIVE || !VERROU_INSTRUMENTATION_IS_ON) {          \
      ...
      typedef OpWithDynSelectedRoundingMode<                                   \
          libMathFunction1<libmq##FCT, double>>                                \
          Op;                                                                  \
      double res;                                                              \
      unsigned int state = VERROU_INSTRUMENTATION_IS_ON;                       \
  ...
  float FCT##f(float a) {                                                      \
    if (ROUNDINGMODE == VR_NATIVE || !VERROU_INSTRUMENTATION_IS_ON) {          \
      ...
      VERROU_STOP_INSTRUMENTATION;                                             \
      typedef OpWithDynSelectedRoundingMode<                                   \
          libMathFunction1<libmq##FCT, float>>                                 \
          Op;                                                                  \
      float res;                                                               \
      Op::apply(Op::PackArgs(a), &res, NULL);                                  \
      if (state)                                                               \
...
#define DEFINE_INTERP_LIBM2_C_IMPL(FCT)                                        \
  ...
  double FCT(double a, double b) {                                             \
    if (ROUNDINGMODE == VR_NATIVE || !VERROU_INSTRUMENTATION_IS_ON) {          \
      ...
      typedef OpWithDynSelectedRoundingMode<                                   \
          libMathFunction2<libmq##FCT, double>>                                \
          Op;                                                                  \
      unsigned int state = VERROU_INSTRUMENTATION_IS_ON;                       \
      VERROU_STOP_INSTRUMENTATION;                                             \
      double res;                                                              \
  ...
  float FCT##f(float a, float b) {                                             \
    if (ROUNDINGMODE == VR_NATIVE || !VERROU_INSTRUMENTATION_IS_ON) {          \
      ...
      typedef OpWithDynSelectedRoundingMode<                                   \
          libMathFunction2<libmq##FCT, float>>                                 \
          Op;                                                                  \
      float res;                                                               \
      unsigned int state = VERROU_INSTRUMENTATION_IS_ON;                       \
      VERROU_STOP_INSTRUMENTATION;                                             \
