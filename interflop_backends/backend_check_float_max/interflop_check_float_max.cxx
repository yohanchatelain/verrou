...
void (*ifmax_debug_print_op)(int, const char *, const double *,
                             const double *) = NULL;
void ifmax_set_debug_print_op(void (*printOpHandler)(
...
const char *IFMAX_FCTNAME(get_backend_name)() { return "check_float_max"; }

const char *IFMAX_FCTNAME(get_backend_version)() { return "1.x-dev"; }
...
void IFMAX_FCTNAME(madd_double)(double a, double b, double c, double *res,
                                void *context) {
  ifmax_checkmax("madd_double", a, b, c, *res);
}

void IFMAX_FCTNAME(madd_float)(float a, float b, float c, float *res,
                               void *context) {
