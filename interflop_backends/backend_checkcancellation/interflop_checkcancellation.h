...
// void IFCC_FCTNAME(mul_double) (double a, double b, double* res, void*
// context); void IFCC_FCTNAME(mul_float)  (float a,  float b,  float*  res,
// void* context); void IFCC_FCTNAME(div_double) (double a, double b, double*
// res, void* context); void IFCC_FCTNAME(div_float)  (float a,  float b, float*
// res, void* context);

// void IFCC_FCTNAME(cast_double_to_float) (double a, float* b, void* context);

void IFCC_FCTNAME(madd_double)(double a, double b, double c, double *res,
                               void *context);
void IFCC_FCTNAME(madd_float)(float a, float b, float c, float *res,
                              void *context);
