...
wget
https://raw.githubusercontent.com/gcc-mirror/gcc/529ebc2a706c4223dc8068a32a195b6c400d1f2d/libquadmath/math/fmaq.c
...
__float128 fmaqApprox(__float128 x, __float128 y, __float128 z) {
  ...
  if (__builtin_expect(u.ieee.exponent + v.ieee.exponent >=
    ...
    if (u.ieee.exponent + v.ieee.exponent > 0x7fff + IEEE854_FLOAT128_BIAS)
      return x * y;
