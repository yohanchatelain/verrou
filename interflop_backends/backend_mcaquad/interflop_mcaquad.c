...
void (*mcaquad_debug_print_op)(int, const char *, const double *,
                               const double *) = NULL;
void mcaquad_set_debug_print_op(void (*printOpHandler)(
...
const char *IFMQ_FCTNAME(get_backend_name)() { return "mcaquad"; }

const char *IFMQ_FCTNAME(get_backend_version)() { return "1.x-dev"; }
...
void mcaquad_set_random_seed() { _mca_set_seed(&mcaquadrandom_seed, 1); }
...
void IFMQ_FCTNAME(madd_double)(double a, double b, double c, double *res,
                               void *context) {
  *res = _mca_dbin_fma(a, b, c);
}

void IFMQ_FCTNAME(madd_float)(float a, float b, float c, float *res,
                              void *context) {
