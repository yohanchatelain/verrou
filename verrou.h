...
typedef enum {
  ...
  VR_USERREQ__INSTRUMENTATION_IS_ON,
...
#define VERROU_PRANDOM_UPDATE                                                  \
  VALGRIND_DO_CLIENT_REQUEST_STMT(VR_USERREQ__PRANDOM_UPDATE, 0, 0, 0, 0, 0)
#define VERROU_PRANDOM_UPDATE_VALUE(P)                                         \
  VALGRIND_DO_CLIENT_REQUEST_STMT(VR_USERREQ__PRANDOM_UPDATE_VALUE, P, 0, 0,   \
                                  0, 0)

#define VERROU_INSTRUMENTATION_IS_ON                                           \
  (unsigned int)VALGRIND_DO_CLIENT_REQUEST_EXPR(                               \
      0, VR_USERREQ__INSTRUMENTATION_IS_ON, 0, 0, 0, 0, 0)
