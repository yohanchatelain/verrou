...
case Iop_AddF64: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcNameWithCC(add64F), VR_OP_ADD,
                            VR_PREC_DBL, VR_VEC_SCAL, countOnly);
  break;

case Iop_Add64F0x2: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcNameWithCC(add64F), VR_OP_ADD,
                           VR_PREC_DBL, VR_VEC_LLO, countOnly);
  break;
case Iop_Add64Fx2: // 128b vector, 2 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcNameWithCC(add64Fx2), VR_OP_ADD,
                           VR_PREC_DBL, VR_VEC_FULL2, countOnly);
  break;

case Iop_AddF32: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcNameWithCC(add32F), VR_OP_ADD,
                            VR_PREC_FLT, VR_VEC_SCAL, countOnly);
  break;

case Iop_Add32F0x4: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcNameWithCC(add32F), VR_OP_ADD,
                           VR_PREC_FLT, VR_VEC_LLO, countOnly);
  break;

case Iop_Add32Fx4: // 128b vector, 4 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcNameWithCC(add32Fx4), VR_OP_ADD,
                           VR_PREC_FLT, VR_VEC_FULL4, countOnly);
  break;

case Iop_Add64Fx4: // AVX double
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcNameWithCC(add64Fx4), VR_OP_ADD,
                           VR_PREC_DBL, VR_VEC_FULL4, countOnly);
  break;

case Iop_Add32Fx8: // AVX Float
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcNameWithCC(add32Fx8), VR_OP_ADD,
                           VR_PREC_FLT, VR_VEC_FULL8, countOnly);
  break;
...
case Iop_SubF64: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcNameWithCC(sub64F), VR_OP_SUB,
                            VR_PREC_DBL, VR_VEC_SCAL, countOnly);
  break;

case Iop_Sub64F0x2: // 128b vector, lowest-lane only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcNameWithCC(sub64F), VR_OP_SUB,
                           VR_PREC_DBL, VR_VEC_LLO, countOnly);
  break;

case Iop_Sub64Fx2:
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcNameWithCC(sub64Fx2), VR_OP_SUB,
                           VR_PREC_DBL, VR_VEC_FULL2, countOnly);
  break;

case Iop_SubF32: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcNameWithCC(sub32F), VR_OP_SUB,
                            VR_PREC_FLT, VR_VEC_SCAL, countOnly);
  break;

case Iop_Sub32F0x4: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcNameWithCC(sub32F), VR_OP_SUB,
                           VR_PREC_FLT, VR_VEC_LLO, countOnly);
  break;

case Iop_Sub32Fx4: // 128b vector, 4 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcNameWithCC(sub32Fx4), VR_OP_SUB,
                           VR_PREC_FLT, VR_VEC_FULL4, countOnly);
  break;

case Iop_Sub64Fx4: // AVX double
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcNameWithCC(sub64Fx4), VR_OP_SUB,
                           VR_PREC_DBL, VR_VEC_FULL4, countOnly);
  break;

case Iop_Sub32Fx8: // AVX Float
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcNameWithCC(sub32Fx8), VR_OP_SUB,
                           VR_PREC_FLT, VR_VEC_FULL8, countOnly);
  break;
  // Multiplication
...
case Iop_MulF64: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcName(mul64F), VR_OP_MUL,
                            VR_PREC_DBL, VR_VEC_SCAL, countOnly);
  break;

case Iop_Mul64F0x2: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcName(mul64F), VR_OP_MUL,
                           VR_PREC_DBL, VR_VEC_LLO, countOnly);
  break;

case Iop_Mul64Fx2: // 128b vector, 2 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcName(mul64Fx2), VR_OP_MUL,
                           VR_PREC_DBL, VR_VEC_FULL2, countOnly);
  break;

case Iop_MulF32: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcName(mul32F), VR_OP_MUL,
                            VR_PREC_FLT, VR_VEC_SCAL, countOnly);
  break;

case Iop_Mul32F0x4: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcName(mul32F), VR_OP_MUL,
                           VR_PREC_FLT, VR_VEC_LLO, countOnly);
  break;

case Iop_Mul32Fx4: // 128b vector, 4 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcName(mul32Fx4), VR_OP_MUL,
                           VR_PREC_FLT, VR_VEC_FULL4, countOnly);
  break;

case Iop_Mul64Fx4: // AVX double
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcName(mul64Fx4), VR_OP_MUL,
                           VR_PREC_DBL, VR_VEC_FULL4, countOnly);
  break;

case Iop_Mul32Fx8: // AVX Float
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcName(mul32Fx8), VR_OP_MUL,
                           VR_PREC_FLT, VR_VEC_FULL8, countOnly);
  break;

case Iop_DivF32:
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcName(div32F), VR_OP_DIV,
                            VR_PREC_FLT, VR_VEC_SCAL, countOnly);
  break;

case Iop_Div32F0x4: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcName(div32F), VR_OP_DIV,
                           VR_PREC_FLT, VR_VEC_LLO, countOnly);
  break;

case Iop_Div32Fx4: // 128b vector, 4 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcName(div32Fx4), VR_OP_DIV,
                           VR_PREC_FLT, VR_VEC_FULL4, countOnly);
  break;

case Iop_DivF64: // Scalar
  res.containFloatModOp =
      vr_replaceBinFpOpScal(sb, stmt, expr, bcName(div64F), VR_OP_DIV,
                            VR_PREC_DBL, VR_VEC_SCAL, countOnly);
  break;

case Iop_Div64F0x2: // 128b vector, lowest-lane-only
  res.containFloatModOp =
      vr_replaceBinFpOpLLO(sb, stmt, expr, bcName(div64F), VR_OP_DIV,
                           VR_PREC_DBL, VR_VEC_LLO, countOnly);
  break;

case Iop_Div64Fx2: // 128b vector, 2 lanes
  res.containFloatModOp =
      vr_replaceBinFullSSE(sb, stmt, expr, bcName(div64Fx2), VR_OP_DIV,
                           VR_PREC_DBL, VR_VEC_FULL2, countOnly);
  break;

case Iop_Div64Fx4: // AVX double
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcName(div64Fx4), VR_OP_DIV,
                           VR_PREC_DBL, VR_VEC_FULL4, countOnly);
  break;

case Iop_Div32Fx8: // AVX Float
  res.containFloatModOp =
      vr_replaceBinFullAVX(sb, stmt, expr, bcName(div32Fx8), VR_OP_DIV,
                           VR_PREC_FLT, VR_VEC_FULL8, countOnly);
  break;

case Iop_MAddF32:
#ifndef IGNOREFMA
  res.containFloatModOp = vr_replaceFMA(sb, stmt, expr, bcNameWithCC(madd32F),
                                        VR_OP_MADD, VR_PREC_FLT, countOnly);
  break;
#else
...
case Iop_MSubF32:
#ifndef IGNOREFMA
  res.containFloatModOp = vr_replaceFMA(sb, stmt, expr, bcNameWithCC(msub32F),
                                        VR_OP_MSUB, VR_PREC_FLT, countOnly);
  break;
#else
  res.containFloatModOp = False;
...
case Iop_MAddF64:
#ifndef IGNOREFMA
  res.containFloatModOp = vr_replaceFMA(sb, stmt, expr, bcNameWithCC(madd64F),
                                        VR_OP_MADD, VR_PREC_DBL, countOnly);
  break;
#else
  res.containFloatModOp = False;
...
case Iop_MSubF64:
#ifndef IGNOREFMA
  res.containFloatModOp = vr_replaceFMA(sb, stmt, expr, bcNameWithCC(msub64F),
                                        VR_OP_MSUB, VR_PREC_DBL, countOnly);
  break;
#else
  res.containFloatModOp = False;
...
#ifndef IGNORECAST
  res.containFloatModOp =
      vr_replaceCast(sb, stmt, expr, bcName(cast64FTo32F), VR_OP_CONV,
                     VR_PREC_DBL_TO_FLT, countOnly);
  break;
#else
  res.containFloatModOp = False;
