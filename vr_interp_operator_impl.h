...
static VG_REGPARM(3) void vr_AvxDoubleCopyFirstArg(ULong a0, ULong a1, ULong a2,
                                                   ULong a3) {
...
static VG_REGPARM(3) void vr_AvxFloatCopyFirstArg(ULong a0, ULong a1, ULong a2,
                                                  ULong a3) {
...
static VG_REGPARM(3) void vr_AvxDoubleCopyFirstArg(ULong a0, ULong a1, ULong a2,
                                                   ULong a3) {
  arg1CopyAvxDouble = (doublex4){*((double *)(&a0)), *((double *)(&a1)),
                                 *((double *)(&a2)), *((double *)(&a3))};
}
