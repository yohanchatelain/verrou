...
#ifdef LINK_INTERFLOP_BACKEND_BACKENDGUARD
...
static VG_REGPARM(3) void FCTNAME(64Fx2, )(/*OUT*/ V128 *output, ULong aHi,
...
static VG_REGPARM(3) void FCTNAME(64Fx4, )(/*OUT*/ V256 *output, ULong b0,
...
static VG_REGPARM(3) void FCTNAME(32Fx8, )(/*OUT*/ V256 *output, ULong b0,
                                           ULong b1, ULong b2, ULong b3) {
  V256 reg2;
  reg2.w64[0] = b0;
  reg2.w64[1] = b1;
...
static VG_REGPARM(3) void FCTNAME(32Fx4, )(/*OUT*/ V128 *output, ULong aHi,
                                           ULong aLo, ULong bHi, ULong bLo) {
  V128 reg1;
  reg1.w64[0] = aLo;
  reg1.w64[1] = aHi;
